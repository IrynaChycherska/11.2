...
int main()
{
	...
	do {
		...
		cout << " [3] - Процент студентів, які отримали з фізики та математики 5:" << endl;
		cout << " [4] - фізичне впорядкування даних" << endl;
		cout << " [5] - Процент оцінок відмінно з кожного предмету:" << endl;
		...
		case 3:
			...
			cout << " Процент студентів, які отримали з фізики та математики 5: " << endl;
			cout << proc << "%" << endl;
		case 4:
			Sort(p, N);
			break;
		case 5:
			proc = CountMarks(p, N);
			cout << "Процент оцінок відмінно з кожного предмету:" << endl;
			cout << proc << "%" << endl;
		case 0:
			break;
		default:
